              ...
              <Sidebar />
              		...
              		<div className="col-xl-9 col-md-8">
						<div className="tab-content pt-0">
							<div className="tab-pane show active" id="user_profile_settings">
									...
									<form>
											...
											<div className="form-group col-xl-12">
												<div className="media align-items-center mb-3">
													...
													<div className="media-body">
														<h5 className="mb-0">Jeffrey Akridge</h5>
														<p>Max file size is 20mb</p>
														<div className="jstinput">	<a href={"#"} className="avatar-view-btn browsephoto openfile">Browse</a>
														</div>
													</div>
												</div>
											</div>
										...
										<div className="row">
											<div className="form-group col-xl-6">
												...
												<input className="form-control" type="text" value="Jeffrey Akridge" readOnly />
											</div>
											<div className="form-group col-xl-6">
												<label className="mr-sm-2">Email</label>
												<input className="form-control" type="email" value="jeffreyakridge@example.com" readOnly />
											</div>
											<div className="form-group col-xl-6">
												<label className="mr-sm-2">Country Code</label>
												<input className="form-control" type="text" value="91" readOnly />
											</div>
											<div className="form-group col-xl-6">
												<label className="mr-sm-2">Mobile Number</label>
												<input className="form-control no_only" type="text" value="410-242-3850" name="mobileno" readOnly required />
											</div>
											<div className="form-group col-xl-6">
												<label className="mr-sm-2">Date of birth</label>
												<input type="text" className="form-control datepicker" autoComplete="off" name="dob" value="01-01-1970" onChange={this.handleChange.bind(this, 'dob')} />
											</div>
											<div className="col-xl-12">
											...
											<div className="form-group col-xl-12">
												...
												<input type="text" className="form-control" name="address" value="" onChange={this.handleChange.bind(this, 'pincode')} />
											</div>
											<div className="form-group col-xl-6">
											...
											<div className="form-group col-xl-6">
												...
												<select className="form-control" name="state_id" id="state_id"></select>
											</div>
											<div className="form-group col-xl-6">
												<label className="mr-sm-2">City</label>
												<select className="form-control" name="city_id" id="city_id"></select>
											</div>
											<div className="form-group col-xl-6">
												<label className="mr-sm-2">Postal Code</label>
												<input type="text" className="form-control" name="pincode" value="665487" onChange={this.handleChange.bind(this, 'pincode')}/>
											</div>
											<div className="form-group col-xl-12">
												<button name="form_submit" id="form_submit" className="btn btn-primary pl-5 pr-5" type="submit">Update</button>
											</div> 
										</div> 
									</form>
								</div>
